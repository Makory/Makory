...
public:
	...
	afx_msg void OnEnUpdateSunsetRedValue();
	afx_msg void OnEnUpdateSunsetGreenValue();
	afx_msg void OnEnUpdateSunsetBlueValue();
	afx_msg void OnEnUpdateSunsetVEdit();
	afx_msg void OnEnUpdateSunsetHEdit();
